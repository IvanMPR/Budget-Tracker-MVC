...
var _modelJs = require("../js_modules/model.js");
var _modelJsDefault = parcelHelpers.interopDefault(_modelJs);
var _viewJs = require("../js_modules/view.js");
...
class Controller {
    ...
    listeners() {
        ...
        document.addEventListener("keydown", (e)=>{
            ...
            if (e.key === "Enter" && !this.v.button.classList.contains("hidden")) this.ctrlAddEntry();
            else if (e.key === "Enter" && !this.v.editButton.classList.contains("hidden")) this.ctrlEditLastSequence(this.m.stateObject.storage.id, this.v.desc.value, this.v.val.value);
        });
        ...
        this.v.editButton.addEventListener("click", ()=>{
            this.ctrlEditLastSequence(this.m.stateObject.storage.id, this.v.desc.value, this.v.val.value);
        });
        window.addEventListener("beforeunload", ()=>{
            localStorage.setItem("entries", JSON.stringify(this.m.entriesArray));
        });
        window.addEventListener("load", ()=>{
            if (localStorage.getItem("entries")) this.ctrlUpdateEntries();
        });
    }
}
const app = new Controller(new (0, _modelJsDefault.default)(), new (0, _viewJsDefault.default)());
app.listeners();

},{"../js_modules/model.js":"dMhD8","../js_modules/view.js":"6PO0t","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dMhD8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Model {
    constructor(){
        this.entriesArray = localStorage.getItem("entries") ? JSON.parse(localStorage.getItem("entries")) : [];
        this.stateObject = {
            incomes: 0,
            expenses: 0,
            total: 0,
    ...
    calcSum(type, arr) {
        return arr.filter((entry)=>entry.type === type).map((entry)=>entry.value).reduce((acc, curr)=>acc + Number(curr), 0);
    }
    ...
    parseDataFromEntries() {
        ...
        const percentage = this.stateObject.expenses / this.stateObject.incomes * 100;
        if (isNaN(percentage) || percentage === Infinity || percentage < 0) this.stateObject.percentage = "---";
        else if (percentage % 1 !== 0) this.stateObject.percentage = `${percentage.toFixed(1)} %`;
        else this.stateObject.percentage = `${percentage} %`;
...
},{}],"6PO0t":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class View {
    constructor(){
    ...
    <li class="transactions__${entry.type}--li" data-id="${entry.id}">
      ...
      <p class="transactions__value transactions__incomes--p">${entry.value}
        ...
        <span title="Delete entry" class="delete"><i class="fa-solid fa-trash-can delete-icon"></i></span>
            ...
            document.querySelector(`.transactions__${entry.type}--ul`).insertAdjacentHTML("beforeend", entryHtml);
        });
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6KagL","gCE4p"], "gCE4p", "parcelRequireb6c3")
